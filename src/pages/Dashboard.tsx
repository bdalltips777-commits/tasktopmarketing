...
import { LogOut, Mail, Facebook, Instagram, Gift, Users, UserCircle, Copy, Check, Loader2, ArrowUpRight, History as HistoryIcon, Briefcase, Send, MessageCircle } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const cards = [
    ...
    { name: 'Refer (রেফার)', path: '/refer', icon: Users, color: 'text-amber-400 bg-amber-500/10 border-amber-500/20' }
  ];
